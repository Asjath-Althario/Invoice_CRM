...
router.post('/', authMiddleware, async (req, res) => {
  const { contact_id, start_date, end_date, frequency, subtotal, tax_amount, total_amount, notes, items: requestItems } = req.body;
...
router.put('/:id', authMiddleware, async (req, res) => {
    ...
    const { id } = req.params;
    const { contact_id, start_date, end_date, frequency, status, subtotal, tax_amount, total_amount, notes, items: requestItems } = req.body;
    ...
    try {
        ...
        if (requestItems) {
            ...
            console.log('Items data:', requestItems);
