...
import { getCompanyProfile, mockCashFlow } from '../../data/mockData';
import type { CompanyProfile, CashFlowSection } from '../../types';
...
const CashFlow: React.FC = () => {
    ...
    const netCashFlow = mockCashFlow.reduce((sum, section) => sum + section.total, 0);
