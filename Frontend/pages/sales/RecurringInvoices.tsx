...
import { getRecurringInvoices, deleteRecurringInvoice } from '../../data/mockData';
...
const RecurringInvoices: React.FC = () => {
    ...
    const refreshData = () => setRecurringInvoices(getRecurringInvoices());
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                        {recurringInvoices.map((invoice) => (
                            <tr key={invoice.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{invoice.startDate}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">{invoice.frequency}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 font-medium">{calculateNextInvoiceDate(invoice.startDate, invoice.frequency)}</td>
